...
+ (UIImage *)imageWithColor:(UIColor *)color
    ...
    UIBezierPath *roundedRect = [UIBezierPath bezierPathWithRoundedRect:rect cornerRadius:.0f];
...
+ (UIImage *)imageWithColor:(UIColor *)color
             ...
             andStrokeWidth:(CGFloat)strokeWidth
               cornerRadius:(CGFloat)cornerRadius {
    CGFloat minEdgeSize = edgeSizeFromCornerRadius(cornerRadius);
    CGRect rect = CGRectMake(0, 0, minEdgeSize, minEdgeSize);
    ...
    [color setFill];
    [roundedRect fill];
    [strokeColor setStroke]; // border color
